...
final class Connections {
    ...
    static let sources: [Source] = [
        ...
        Source(name: "National Park Service",
               ...
               essential: true),
        Source(name: "OSRM",
               what: "Every distance and wheel time in the app. Without it a trip has parks and no legs between them.",
               keys: ["routing (OSRM)"],
        ...
        Source(name: "Apple Maps",
               what: "Fuel, charging, food and beds near a park; a park's own website and phone number; the pictures of routes and the atlas. On the phone's own framework — it answers without going through this app's network layer, so it shows as heard from only when something asks it.",
               keys: ["parks (Apple Maps)", "city lookup", "EV charging"]),
